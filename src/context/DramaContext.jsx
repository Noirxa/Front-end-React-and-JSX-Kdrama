...
//             .then(res => res.json())
//             .then(data => {
//                 // VEILIGHEIDS-FIX: Zorg dat elk item een 'isFavorite' property heeft,
//                 // ook als de database nog 'isBookmarked' gebruikt.
...
//         // Kijkt nu naar de correcte property
...
export function DramaProvider({ children }) {
    ...
    // Aangepaste filter logica: zoekt nu in Titel EN Genre
    const filteredDramas = dramas.filter(d => {
        const matchesSearch =
